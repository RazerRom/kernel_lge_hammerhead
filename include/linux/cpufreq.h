...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_GAMERACTIVE)
extern struct cpufreq_governor cpufreq_gov_gameractive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_gameractive)
#endif
