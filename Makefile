...
ARCH		?= arm
CROSS_COMPILE	?=  ../../UBERTC/out/arm-linux-androideabi-4.9-cortex-a15/bin/arm-linux-androideabi-
...
KERNELFLAGS	= -pipe -DNDEBUG -O3 -ffast-math -mtune=cortex-a15 -mcpu=cortex-a15 -marm -mfpu=neon-vfpv4 -mneon-for-64bits -fopenmp -fopenmp-simd -ftree-vectorize -ftree-loop-ivcanon -fivopts -fmodulo-sched -fmodulo-sched-allow-regmoves -mvectorize-with-neon-quad -munaligned-access -fgcse-lm -fgcse-sm -fgcse-las -fsingle-precision-constant -fforce-addr -fsched-spec-load -funroll-loops -fpredictive-commoning -floop-nest-optimize -fgraphite -fgraphite-identity -floop-parallelize-all -ftree-loop-linear -ftree-loop-im -floop-interchange -floop-strip-mine -floop-block -floop-flatten -frename-registers -fsimd-cost-model=unlimited -std=gnu89
