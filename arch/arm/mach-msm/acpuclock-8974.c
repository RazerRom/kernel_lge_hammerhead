...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
		...
		{ 1, {  192000, HFPLL, 2,  20 },  L2(0),  780000,   1 },
		{ 1, {  249600, HFPLL, 2,  26 },  L2(0),  785000,   1 },
		{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  790000,  72 },
		{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  795000,  83 },
		{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  800000, 101 },
		{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  805000, 120 },
		{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  810000, 139 },
		{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  815000, 159 },
		{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  820000, 180 },
		{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  830000, 200 },
		{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  840000, 221 },
		{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  850000, 242 },
		{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  870000, 264 },
		{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  890000, 287 },
		{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  910000, 308 },
		{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  930000, 333 },
		{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  950000, 356 },
		{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  970000, 380 },
		{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  980000, 404 },
		{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  985000, 430 },
		{ 0, { 1651200, HFPLL, 1,  86 }, L2(17),  990000, 456 },
		{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  995000, 482 },
		{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1000000, 510 },
		{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1005000, 538 },
		{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1010000, 565 },
		{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1015000, 596 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
		{ 1, {   96000, HFPLL, 2,  10 },  L2(0),  725000,   1 },
		{ 1, {  192000, HFPLL, 2,  20 },  L2(0),  730000,   1 },
		{ 1, {  249600, HFPLL, 2,  26 },  L2(0),  740000,   1 },
		{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  72 },
		{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  755000,  83 },
		{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  760000, 101 },
		{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  765000, 120 },
